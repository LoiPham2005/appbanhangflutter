...
function Dashboard() {
  const { t } = useTranslation(); // Chỉ giữ lại t từ useTranslation
  const { isDarkMode } = useTheme(); // Chỉ giữ lại isDarkMode để kiểm tra theme
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      console.log('Dashboard stats response:', response); // Thêm log để debug
      ...
      // Có thể thêm xử lý lỗi ở đây (hiện thông báo, vv)
    } finally {
      setLoading(false);
    }
  };
